...
/*!
 @header ToDoList+Remote
 @abstract Remote category for ToDoList class
 */

#import "ToDoList.h"

/*!
 @category ToDoList (Remote)
 @abstract Adds remote CRUD capabilities to ToDoList.
 @discussion Serves as a strongly-typed wrapper around @link //apple_ref/occ/cat/APObject(Remote) @/link methods.
 */ 
@interface ToDoList (Remote)
