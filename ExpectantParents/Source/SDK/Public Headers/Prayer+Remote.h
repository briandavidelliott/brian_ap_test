...
/*!
 @header Prayer+Remote
 @abstract Remote category for Prayer class
 */

#import "Prayer.h"

/*!
 @category Prayer (Remote)
 @abstract Adds remote CRUD capabilities to Prayer.
 @discussion Serves as a strongly-typed wrapper around @link //apple_ref/occ/cat/APObject(Remote) @/link methods.
 */ 
@interface Prayer (Remote)
