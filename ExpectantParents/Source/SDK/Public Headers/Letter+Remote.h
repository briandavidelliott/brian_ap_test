...
/*!
 @header Letter+Remote
 @abstract Remote category for Letter class
 */

#import "Letter.h"

/*!
 @category Letter (Remote)
 @abstract Adds remote CRUD capabilities to Letter.
 @discussion Serves as a strongly-typed wrapper around @link //apple_ref/occ/cat/APObject(Remote) @/link methods.
 */ 
@interface Letter (Remote)
