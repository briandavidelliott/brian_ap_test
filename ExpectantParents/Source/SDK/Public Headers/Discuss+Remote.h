...
/*!
 @header Discuss+Remote
 @abstract Remote category for Discuss class
 */

#import "Discuss.h"

/*!
 @category Discuss (Remote)
 @abstract Adds remote CRUD capabilities to Discuss.
 @discussion Serves as a strongly-typed wrapper around @link //apple_ref/occ/cat/APObject(Remote) @/link methods.
 */ 
@interface Discuss (Remote)
