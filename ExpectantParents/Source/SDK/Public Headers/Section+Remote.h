...
/*!
 @header Section+Remote
 @abstract Remote category for Section class
 */

#import "Section.h"

/*!
 @category Section (Remote)
 @abstract Adds remote CRUD capabilities to Section.
 @discussion Serves as a strongly-typed wrapper around @link //apple_ref/occ/cat/APObject(Remote) @/link methods.
 */ 
@interface Section (Remote)
